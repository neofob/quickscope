...
struct QsRungeKutta4 *qsRungeKutta4_create(
    QsRungeKutta4_ODE_t derivatives,
    void *data,
    int n /*dimensions*/, long double tStart,
...
static inline
void qsRungeKutta4_setTStep(struct QsRungeKutta4 *rk4,
    long double tStep)
{
  QS_ASSERT(rk4);
  QS_ASSERT(tStep > 0);
...
static inline
void qsRungeKutta4_setODEData(struct QsRungeKutta4 *rk4, void *data)
{
  QS_ASSERT(rk4);
  rk4->data = data;
}
