...
int main(int argc, char **argv)
{
  ...
  sweep = qsSweep_create(12.731F /*period*/,
      0.0F/*level*/,
      // This adds program arg option --slope=INT with default slope 0
      // valid slopes are -1, 0, +1
      qsApp_int("slope", 0),
      0.0F/*holdOff*/,
      // This adds arg option --delay=VAL with default 0
  ...
  for(i=0; i<3; ++i)
  {
    ...
    // This adds arg option --swipe=BOOL with default true
